  ...
  return (
    <AdminAuthenticatedLayout>
      ...
      >
        ...
        <Paragraph>
          I, the undersigned, understand that participation in any fitness
          class, physical training, or related activity at{" "}
        ...
        <Paragraph>
          ...
          training, or activity offered by{" "}
          <span className="font-bold">8 Club Lagree</span>, I hereby release,
          waive, and discharge <span className="font-bold">8 Club Lagree</span>,
          its owners, partners, instructors, staff, agents, and representatives
          from any and all claims, liabilities, demands, or causes of action
          arising out of or related to any loss, injury, disability, death, or
          damage to person or property—whether caused by negligence or
          otherwise—occurring while participating in, or as a result of
          participation in, any <span className="font-bold">8 Club Lagree</span>{" "}
          activity or use of its facilities or equipment.
        </Paragraph>{" "}
        <Paragraph>
          {" "}
        ...
        <Paragraph>
          ...
          permission to any <span className="font-bold">8 Club Lagree</span>{" "}
          staff member to administer first aid as deemed necessary, and to seek
          medical or surgical care, including transportation to a medical
        ...
        <Paragraph>
          ...
          instructors, employees, and agents from and against any and all
        ...
        <Paragraph>
          ...
          2012 (Republic Act No. 10173) and other applicable laws and
        ...
        <Paragraph>
          ...
          scheduling, account management, and communication regarding{" "}
          <span className="font-bold">8 Club Lagree</span> updates, promotions,
          or policy changes. Your information will not be shared with any third
        ...
        <Paragraph>
          ...
          website or social media platforms. However, the studio will always
          seek explicit consent before featuring any identifiable client in
