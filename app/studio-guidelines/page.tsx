...
const canonicalPath = "/studio-guidelines";
const title =
      ...
      <UnauthenticatedLayout>
        ...
        <div className="mx-auto max-w-3xl px-4 pt-[30px] pb-10 sm:py-14">
          ...
          <article className="mt-10 space-y-10">
            ...
            {/* VII. Participant Age and Eligibility */}
              ...
              <div className="mt-5 space-y-4">
                <div className="rounded-2xl border border-slate-200 p-5">
                  ...
                  <ul className="mt-2 list-disc pl-5 text-slate-700 space-y-1.5">
                    <li>
                      International travel (airfare proof required)
                    </li>
                    <li>
